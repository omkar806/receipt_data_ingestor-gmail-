...
async def fetch_receipts(access_token: str, brand_name: Optional[str], user_id: str, session_id: str):
    ...
    while True:
        ...
        if total_processed > 100: # only process 100 receipts in one session
            break
        ...
        messages = filter_messages(messages, user_id)
        ...
        # Add a 20-second delay after processing each batch
